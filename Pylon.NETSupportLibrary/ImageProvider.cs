    ...
    public class ImageProvider
    {
        ...
        public void SetPacketSize(long value)
        {
            if (Pylon.DeviceFeatureIsWritable(m_hDevice, "GevSCPSPacketSize"))
            {
                ...
                Pylon.DeviceSetIntegerFeature(m_hDevice, "GevSCPSPacketSize", value);
            }
        }
        ...
        public void SetInterPacketDelay(long value)
        {
            if (Pylon.DeviceFeatureIsWritable(m_hDevice, "GevSCPD"))
            {
                Pylon.DeviceSetIntegerFeature(m_hDevice, "GevSCPD", value);
            }
        }

        public long GetInterPacketDelay()
        {
            long value = 0;

            if (Pylon.DeviceFeatureIsReadable(m_hDevice, "GevSCPD"))
            {
                value = Pylon.DeviceGetIntegerFeature(m_hDevice, "GevSCPD");
            }
        ...
        #region 파라미터 설정
        public void SetSequencerMode(bool value)
        {
            try
            {
                if (value)
        ...
        public void SetExposure(int value, DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    Pylon.DeviceSetIntegerFeature(m_hDevice, "ExposureTimeRaw", value);
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    Pylon.DeviceSetFloatFeature(m_hDevice, "ExposureTime", value);
                }
            }
            catch (Exception e)
            {
        ...
        public void SetFrameRate(double value, DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    Pylon.DeviceSetFloatFeature(m_hDevice, "AcquisitionFrameRateAbs", value);
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    Pylon.DeviceSetFloatFeature(m_hDevice, "AcquisitionFrameRate", value);
                }
            }
            catch(Exception e)
            {
        ...
        public void SetFrameRateEnable(bool value)
        {
            try
            {
                Pylon.DeviceSetBooleanFeature(m_hDevice, "AcquisitionFrameRateEnable", value);
            }
            catch (Exception e)
            {
        ...
        public void SetWhiteBalanceEnable(bool value)
        {
            try
            {
                Pylon.DeviceSetBooleanFeature(m_hDevice, "BalanceWhiteAuto", value);
            }
            catch (Exception e)
            {
        ...
        public void SetWhiteBalance()
        {
            ...
            Pylon.DeviceFeatureFromString(m_hDevice, "BalanceWhiteAuto", "Once");

        }

        public void SetSensorReadoutMode(string value)
        {
        ...
        public long GetGainMin(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
        ...
        public long GetGainMax(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
        ...
        public long GetExposure(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    return Pylon.DeviceGetIntegerFeature(m_hDevice, "ExposureTimeRaw");
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    double d = Pylon.DeviceGetFloatFeature(m_hDevice, "ExposureTime");
                    return Convert.ToInt32(d);
                }
                else
                {
        ...
        public long GetExposureMin(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    return Pylon.DeviceGetIntegerFeatureMin(m_hDevice, "ExposureTimeRaw");
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    double d = Pylon.DeviceGetFloatFeatureMin(m_hDevice, "ExposureTime");
                    return Convert.ToInt32(d);
                }
                else
                {
        ...
        public long GetExposureMax(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    return Pylon.DeviceGetIntegerFeatureMax(m_hDevice, "ExposureTimeRaw");
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    double d = Pylon.DeviceGetFloatFeatureMax(m_hDevice, "ExposureTime");
                    return Convert.ToInt32(d);
                }
                else
                {
        ...
        public double GetFrameRate(DeviceEnumerator.Device device)
        {
            try
            {
                if (device.DeviceClass.Equals("BaslerGigE"))
                {
                    return Pylon.DeviceGetFloatFeature(m_hDevice, "AcquisitionFrameRateAbs");
                }
                else if (device.DeviceClass.Equals("BaslerUsb"))
                {
                    return Pylon.DeviceGetFloatFeature(m_hDevice, "AcquisitionFrameRate");
                }
                else
                {
                    return 0;
        ...
        public bool GetFrameRateEnable()
        {
            try
            {
                return Pylon.DeviceGetBooleanFeature(m_hDevice, "AcquisitionFrameRateEnable");
            }
            catch (Exception e)
            {
                return false;
        ...
        public bool GetWhiteBalanceEnable()
        {
            try
            {
                return Pylon.DeviceGetBooleanFeature(m_hDevice, "BalanceWhiteAuto");
            }
            catch (Exception e)
            {
                return false;
        ...
        public string GetSensorReadoutMode()
        {
            try
            {
                return Pylon.DeviceFeatureToString(m_hDevice, "SensorReadoutMode");
            }
            catch (Exception e)
            {
                return "";
